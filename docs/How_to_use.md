...
export RUNTIME_LISTEN_HOST='127.0.0.1'
export RUNTIME_LISTEN_PORT='18081'
export AGENT_SERVER_HOST='http://127.0.0.1:18081'
export RUNTIME_PROVIDER='agent_server'
export AGENT_ENABLE_SKILLS='true'
export LLAMA_CPP_MODEL='/path/to/llm_models'
export AGENT_WORKING_DIR='/path/to/dir'
export VLLM_HOST='http://127.0.0.1:58000'
export NO_PROXY='127.0.0.1,localhost'
export no_proxy='127.0.0.1,localhost'
export LLAMA_CPP_N_CTX='262144'
export LLAMA_CPP_MAX_NEW_TOKENS='8192'
export LLAMA_CPP_FLASH_ATTN='enabled'
export LLAMA_CPP_N_BATCH='-1'
export LLAMA_CPP_N_UBATCH='-1'
export LLAMA_CPP_TEMPERATURE='0.7'
export LLAMA_CPP_TOP_P='0.9'
export LLAMA_CPP_SEED='42'
export LLAMA_CPP_N_GPU_LAYERS='all'
export LLAMA_CPP_OFFLOAD_KQV='0'
